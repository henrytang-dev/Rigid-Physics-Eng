...
physics_engine::RigidBody::RigidBody() {
    index = -1;
    reset();
}
...
void physics_engine::RigidBody::localToWorld(
    double x,
    double y,
    double *w_x,
    double *w_y ) 
...
double physics_engine::RigidBody::energy() const {
...
void physics_engine::RigidBody::worldToLocal( 
    double x,
    double y,
    double *l_x,
    double *l_y
...
void physics_engine::RigidBody::reset() {
    p_x = p_y = 0.0;
    v_x = v_y = 0.0;
